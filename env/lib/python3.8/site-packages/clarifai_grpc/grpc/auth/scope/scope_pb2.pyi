...
class S(object):
    ...
    Teams_Get = typing___cast(SValue, 74)
    Teams_Add = typing___cast(SValue, 75)
    Teams_Delete = typing___cast(SValue, 76)
    TeamUsers_Get = typing___cast(SValue, 77)
    TeamUsers_Add = typing___cast(SValue, 78)
    TeamUsers_Delete = typing___cast(SValue, 79)
    TeamApps_Get = typing___cast(SValue, 83)
    TeamApps_Add = typing___cast(SValue, 84)
    TeamApps_Delete = typing___cast(SValue, 85)
    Roles_Get = typing___cast(SValue, 80)
    Organizations_Get = typing___cast(SValue, 86)
    Organizations_Add = typing___cast(SValue, 87)
    Organizations_Delete = typing___cast(SValue, 88)
    IdentityProviders_Get = typing___cast(SValue, 89)
    IdentityProviders_Add = typing___cast(SValue, 90)
    IdentityProviders_Delete = typing___cast(SValue, 91)
    Org_ListAllApps = typing___cast(SValue, 92)
    OrganizationMembers_Delete = typing___cast(SValue, 93)
    OrganizationMembers_Add = typing___cast(SValue, 94)
    OrganizationMembers_List = typing___cast(SValue, 99)
    UserOrganizations_Get = typing___cast(SValue, 95)
    OrganizationInvitations_Add = typing___cast(SValue, 100)
    OrganizationInvitations_Get = typing___cast(SValue, 101)
